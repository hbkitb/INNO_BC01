codeunit 50108 "CreditNote Handler ITB"
{
    ...
    local procedure CreateOrderTransferLines(SalesHeader: Record "Sales Cr.Memo Header")
    var
    ...
    begin
        ...
        if SalesHeader.DKEXPORT then begin
            ...
            if not HideConf then begin
                ConfText := 'Kreditnota nr. ' + SalesHeader."No." + ' er eksporteret vil du forsætte?';
            ...
            repeat
                if itemI.Get(Lines."No.") then begin  //160221
                    if itemI.Type = itemI.Type::Inventory then begin  //160221
                        ...
                        OrderTab.Antal := -Lines.Quantity;  //da kreditnota - 110122
    ...
    local procedure CheckIfAllLinesAreExported(SalesHeader: Record "Sales Cr.Memo Header")
    var
        Lin: Record "Sales Cr.Memo Line";
        i: Integer;
    begin
        i := 0;
    ...
    procedure ExportAllSelectedInvoices(SalesList: Record "Sales Cr.Memo Header")
    var
        Header: Record "Sales Cr.Memo Header";
