report 50110 "Inno_Debtor_Statistic"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'layouts/50110_INNO_Debtor_stat.rdl';  //'./CustomerSalesList.rdlc';
    ApplicationArea = Basic, Suite;
    Caption = 'INNO Debtor Statistic';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            //HBK / ITB - 230322
            column(SalesRepNLbl; SalesRepNLbl)
            {
            }
            column(SalesRepName; SalesRepName)
            {
            }
            //HBK / ITB - 230322             
            ...
            var
                ...
                SalesPur: Record "Salesperson/Purchaser";  //HBK - 290922

            begin
                AmtSalesLCY := CalculateAmtOfSaleLCY;
                //280922  if AmtSalesLCY < MinAmtLCY then
                //280922     CurrReport.Skip();
                ...
                Clear(SalesPur);
                SalesPur.Reset;
                SalesPur.SetRange(Code, "Salesperson Code");
                if SalesPur.FindSet then
                    SalesRepName := SalesPur.Name
                else
                    SalesRepName := '';
                //HBK / ERPG - 290922      
            end;
    ...
    var
        ...
        SalesRepLbl: Text[10];
        SalesRepName: Text[30];  //290922
        SalesRepNLbl: Label 'Sælgernavn';  //290922
