report 50107 "SalesInv_Btekst_Mail"
{
    RDLCLayout = './StandardSalesInvoice.rdlc';
    WordLayout = 'REP/layout/SalInv_BT.docx';   //'./StandardSalesInvoice.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(ITBLink_Url; ITBLink_Url)
            {
            }
            ...
            begin
                ...
                //hbk    CurrReport.Language := Language.GetLanguageIdOrDefault("Language Code");
                //270421 "Package Tracking No." := 'www.itbasen.dk' + "Package Tracking No.";  //HBK / ITB - 160421
                ...
                //hbk PaymentInstructionsTxt := O365SalesInvoiceMgmt.GetPaymentInstructionsFromPostedInvoice(Header);
    ...
    var
        ...
        PakkeLbl: Label 'PakkeLink';  //HBK / ITB
