page 50125 Api_CrMemoHeader
{
    PageType = API;  //
    Caption = 'api_CrMemoHeader';
    APIPublisher = 'ITB';
    APIGroup = 'ITBGroup';
    APIVersion = 'v1.0';
    EntityName = 'CrMemoHeader';
    EntitySetName = 'innoCrMemoHeader';
    ...
    layout
    {
        area(Content)
        {
            ...
            repeater(Generel)
            {
                ...
                field(OrderNo; Rec."Return Order No.")
                {
                    ApplicationArea = All;
                    Caption = 'Ordre-/KreditnotaNummer';
                }
